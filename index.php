          ...
          if (isset($_POST['submit'])) {
            ...
            if (($nama == "") or ($angkatan == "")) {
              ...
              if ($rows > 0) {
                ...
                $sql = "INSERT INTO spk_calon (nama, prodi, angkatan) 
          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <th><i class="fa fa-arrow-down"></i> Nama Calon</th>
                <th><i class="fa fa-arrow-down"></i> Program Studi</th>
                <th><i class="fa fa-arrow-down"></i> Angkatan</th>
            ...
            <tbody>
              <?php
              $b = 0;
              $sql = "SELECT*FROM spk_calon ORDER BY nama ASC";
              $hasil = $conn->query($sql);
              $rows = $hasil->num_rows;
              if ($rows > 0) {
